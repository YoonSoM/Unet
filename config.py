...
class UNetConfig:
    ...
    def __init__(self,
        ...
        self.images_dir = '/content/unet-nested-multiple-classification/data/Images'
        self.masks_dir = '/content/unet-nested-multiple-classification/data/masks'
        self.checkpoints_dir = '/content/unet-nested-multiple-classification/data/.ipynb_checkpoints'
